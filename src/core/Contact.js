...
export default function Contact() {
  ...
  return (
    <section id="contact">
      ...
      >
        <Grid container>
          <Grid xs={12} md={6} sx={{textAlign:'center',margin:'auto'}} >
            <Paper
              elevation={8}
              sx={{
                margin: {xs:1,md:0},
          ...
          <Grid xs={12} md={8}>
            ...
            <Box sx={{ mt: 2 }}>
              <Typography variant="body2" gutterBottom>
                - Users who curse or are accused of blasphemy to players and
                teams will not be a WORKER after the first warnings and his
              ...
              <Typography variant="body2" gutterBottom>
                - Users who share illegal media will not be Worker if they will continue to commit an offense after the first warnings then their posts relating to cause him banned will be deleted!
              </Typography>
              <Typography variant="body2" gutterBottom>
                - We are working on a program that users can use to show their tactical animations and images. Please wait for it patiently!
              </Typography>
            </Box>
            <Box
              sx={{
