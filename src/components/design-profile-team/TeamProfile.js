...
export default function TeamProfile(props) {
  const team = countries.find(
    (country) => country.label === props.team?.country
  );
  return (
    <Box
      sx={{
    ...
    >
      ...
      >
        ...
        >
          {props.team?.country && (
            <img
              ...
              loading="lazy"
              alt="Country"
              src={`https://flagcdn.com/w20/${team?.code.toLowerCase()}.png`}
        ...
        >
          <Tooltip placement="bottom" title="Number of Members" >
            <CardMembershipIcon />
          </Tooltip>
          <Typography
            sx={{
      ...
      >
        ...
        >
          <Tooltip placement="bottom" title="Number of Players" >
            <GroupsIcon />
          </Tooltip>
          <Typography
            sx={{
          ...
          >
            {props.players === 0 ? 0 : props.players}
          </Typography>
        </Grid>
        <Grid
          item
        ...
        >
          <Tooltip placement="bottom" title="Total Market Value" >
            <AttachMoneyIcon />
          </Tooltip>
          <Typography
            sx={{
          ...
          >
            {props.total ? kFormatter(props.total) : 0}
          </Typography>
        </Grid>
      </Grid>
    </Box>
